            ...
            <div className=" flex justify-between mt-20 md:w-auto w-full ">
                ...
                <div className="w-[80%]  md:block hidden">
                    ...
                    <div className='bg-blue-400	 p-8 my-4	'>
                        <p className='text-white flex gap-3  '><AiOutlineInfoCircle 
                        className='text-white text-2xl font-bold inline  ' />هل تحتاج الي مساعده ف طلبيتك؟</p>
