...
const ProductGallery = () => {
    return <>
        <div className="gallery-container w-2/3 flex flex-col gap-3">
            <div className="details-Gallery flex flex-row gap-3">
                <img src="https://media.alshaya.com/adobe/assets/urn:aaid:aem:4d7cf004-02f0-48d5-b1a1-0ceaba4e4729/as/EID-9e1fe34d96f1ae888f43bb80e613776419175970.jpg?width=420&height=630&preferwebp=true" alt="" />
            ...
            <div className="details-Gallery flex flex-row gap-4">
