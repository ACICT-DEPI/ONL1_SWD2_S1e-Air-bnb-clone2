...
const SideBar = (props) => {
    ...
    const visits = Math.floor(Math.random() * (30 - 5 + 1)) + 5
    ...
    return (
        <>
            <div className="product-sideBar w-3/3 h-fit sticky top-0 pr-5 flex lg:flex-col flex-row flex-wrap lg:w-1/3 sm:gap-20 lg:gap-0">
                <>
                    <div className="sec1">
                        <div className="product-title text-xl mb-4 mt-3">
                            {props.title}
                        </div>
                        ...
                        <div className="underline underline-offset-4 text-sm mt-5">
                            كتابة مراجعة
                        </div>
                    </div>
                    <div className="sec2">
                        ...
                        <div className="flex flex-row items-center">
                            <button
                                className="bg-black hover:bg-gray-600 text-white font-bold py-2 px-16 border border-black mt-5 transition-all flex flex-row gap-3"
                            ...
                            <div
                                className="share flex flex-row items-center mr-4 mt-6 hover:cursor-pointer"
                                onClick={openShare}
                            >
                        ...
                        <div className="flex flex-row items-center gap-3 mt-4">
                            <img
                                src="https://eg.hm.com/themes/custom/transac/alshaya_white_label/imgs/icons/style-icons-ui-return.svg"
                                alt="Return policy"
                            />
                            <div>
                                خدمة الإرجاع المجاني أونلاين متوفرة حتى 14 يوماً
                            </div>
                        </div>
                    </div>
                </>
