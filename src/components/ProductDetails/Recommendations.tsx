...
const Recommendations =()=>{
    ...
    const prodcuts = [
        ...
        },
        {
            id: "",
            name: "كنزة بقبة مستديرة",
            image: "https://media.alshaya.com/adobe/assets/urn:aaid:aem:1199a8a6-1370-4985-a509-0a5c190dc236/as/EID-064ed2d221e277df45d0fe14fda7a94aee77fca1.jpg?width=450&height=675&preferwebp=true",
            price: 799,
        },
        {
            id: "",
            name: "كنزة بقبة مستديرة",
            image: "https://media.alshaya.com/adobe/assets/urn:aaid:aem:0a077dcf-f063-418d-982d-aa1756677fd1/as/EID-4b0ffe86cffbcaab57233c67a2896a205ac465f9.jpg?width=450&height=675&preferwebp=true",
            price: 799,
        },
    ];
    ...
    return (
        <div className="flex flex-col items-center justify-center my-5 gap-5 relative">
            <p className="text-3xl">منتجات اشتراها الزبائن</p>
